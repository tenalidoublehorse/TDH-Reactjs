				...
				<div className="container">
					...
					<div className="ltn__gallery-active row ltn__gallery-style-2 ltn__gallery-info-hide---">
						...
						<div className="ltn__gallery-item-inner" >
							...
							<a href={publicUrl+"/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} data-rel="magnific:myCollection">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href="#ltn__inline_description_1" data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href="//www.youtube.com/embed/6v2L2UGZJAM?version=3" data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href="https://player.vimeo.com/video/47362400" data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href={publicUrl+"/assets/media/1.mp4"} data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href={publicUrl+"assets/img/gallery/1.jpg"} data-rel="magnific:myCollection" data-bs-lc-caption="Your caption Here">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href={publicUrl+"img/gallery/no-image.jpg"} data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
						...
						<div className="ltn__gallery-item-inner">
							<div className="ltn__gallery-item-img">
							<a href={publicUrl+"assets/img/gallery/1.jpg"} data-rel="magnific:myCollection">
							<img src={process.env.PUBLIC_URL + "/assets/img/prods/tenali-double-horse-about-page-tdhf-section.png"} alt="img" className=' mb-2' />
								<span className="ltn__gallery-action-icon">
								<i className="fas fa-search" />
								</span>
