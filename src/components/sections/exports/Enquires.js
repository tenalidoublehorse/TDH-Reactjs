        ...
        return (
            <Fragment>
                ...
                <div className="ct-menu-categories menu-filter">
                    ...
                    <h5 className="text-white text-center">Global Country Showcase</h5>
...
<div className="fluid-container locations-wrapper  ">
  <div className="container">
    <div className="section-title-wrap text-center mb-5">
      <h5 className="custom-primary">Connections</h5>
      <h2 className="title">Global Market Expansion</h2>
      <p className="subtitle">
      Fostering strategic partnerships for global market expansion and enhanced trade relationships.
      </p>
    </div>
    <div className="row  p-2  ">
      <div className="col-lg-7  mb-lg-5 " style={{ display: 'flex', justifyContent: 'start', alignItems: 'center', }}>

       
      <img src={process.env.PUBLIC_URL + "/assets/img/prods/exports-trail.png"} alt="img" className=' mb-2' />
       ...
       ">
        <div className="row  top-row">
          <div className="col-lg-12 col-sm-12 mb-3 p-2 d-flex email-toll-card3 pb-3" style={{ display: 'flex', justifyContent: 'start', alignItems: 'center', }}>
            ...
            <div> <h5 className="text-white mb-0 mt-2"> Global Export Enquiry Form</h5></div>
