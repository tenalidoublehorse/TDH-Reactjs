                      ...
                      <div className="row contact-info d-flex " >
                        <div className="col-lg-6">
                          ...
                          <i className='fas fa-phone mt-3'></i>
                            ...
                            <p className='text-start'><a href="tel: 1800 270 567567">1800 270 567567</a></p>
                          </div>
                        ...
                        <div className="col-lg-6">
                          ...
                          <i className='fas fa-envelope mt-3 phone-email'></i>
                            ...
                            <p className='text-start'> <a href="mailto: info@tenalidoublehorse.com">info@tenalidoublehorse.com</a></p>
                          </div>
