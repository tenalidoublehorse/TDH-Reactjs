        ...
        return (
            <div className="section">
                ...
                <div className="section-title-wrap section-header text-center ">
                    ...
                    Explore TDH Rishika, our renowned subsidiary brand known for iconic Sunnundalu and instant mixes like dosa, idly, and vada. Elevate your culinary journey with authentic flavors and easy preparation.
                    </p>
                </div>
                    <div className="row ">
